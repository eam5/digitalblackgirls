    ...
    <footer role="contentinfo">
        ...
        <div class="footer-content">
            ...
            <div class="to-top">
                <a href="#wrap" aria-label="Back to top">
        ...
        <!-- <?php
    if (@$bodyid === 'home'):
        $footerMessage = __(link_to_home_page(option('site_title')).' is run by Dr. Aria S. Halliday & Dr. Ashleigh Greene Wade');

    else:
        $footerMessage = __('Proudly powered by <a href="http://omeka.org">Omeka</a>.');

    endif;
    ?> -->
        <!-- <span><?php echo $footerMessage; ?><span> -->
